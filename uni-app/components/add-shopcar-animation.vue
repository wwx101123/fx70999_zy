<template>
	<view>
		<view class="container">
			<!-- 底部购物车 -->
			<view class="shopcar-bus">
				<image src="../../static/index/shopcar.png"></image>
	...
	export default {
		...
		methods:{
			touchOnGoods: function(e) {
				...
				this.linePos = this.$commonData.bezier([this.finger, topPoint, this.busPos], 30);
				this.startAnimation();
			},
		...
		onShow() {
			this.count = uni.getStorageSync('cart_count');
		}
	}
</script>
<style lang="scss">
