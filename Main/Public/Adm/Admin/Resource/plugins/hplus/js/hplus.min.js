...
layer.config({
    ...
    if ($("#fixednavbar").click(function () {
            ...
            return $("body").removeClass("skin-1"), $("body").removeClass("skin-4"), $("body").removeClass("skin-3"), !1
        }), $(".s-skin-1").click(function () {
            return $("body").removeClass("skin-4"), $("body").removeClass("skin-3"), $("body").addClass("skin-1"), !1
        }), $(".s-skin-4").click(function () {
            return $("body").removeClass("skin-1"), $("body").removeClass("skin-3"), $("body").addClass("skin-4"), !1
        }), $(".s-skin-3").click(function () {
            return $("body").removeClass("skin-1"), $("body").removeClass("skin-4"), $("body").addClass("skin-3"), !1
        }), localStorageSupport) {
