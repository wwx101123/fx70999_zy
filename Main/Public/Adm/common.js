...
//执行回传函数
function ExePostBack(objId, objmsg ,form_id) {
    
   
  
        var self=$(this);
        layer.confirm(objmsg,{icon: 3, title:'提示'},function(index) {
...
var src=($(obj).children("img").eq(0).attr("src")); 
