...
{	   	
	var upurl ='/adm.php/Uploadify/upload?num='+num+'&input='+elementid+'&path='+path+'&func='+callback+'&fileType='+fileType;
    var title = '上传图片';
    if(fileType == 'Flash'){
        title = '上传视频';
    }
...
function ClearPicArr2(obj, path) {
	$.ajax({
		type : 'GET',
		url : "/adm.php/Uploadify/delupload.html",
		data : {
			action : "del",
			filename : path
		},
	...
	$.ajax({
		type : 'GET',
		url : "/adm.php/Uploadify/del_goods_images.html",
		data : {
			filename : path
		},
		success : function() {
