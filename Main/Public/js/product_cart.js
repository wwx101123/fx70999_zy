				...
				if(status == 1) {
					...
					if(info != null) {
						...
						$.each(info, function(index, content) {
							...
							item += '<ul class="order_info_tips" style="padding-left: 0px;">                                                      <li><img class="icon_optional" src="//img11.360buyimg.com/jdphoto/s36x36_jfs/t8560/137/813901852/1321/4ea0867/59af98d4Nb287ee5f.png">支持7天无理由退货</li>                                                                                                                                                                            </ul>';
...
//打开规格选择窗口
function showActionSheet(actiontype, webpath, linkurl, order_id = 0) {
	//显示窗口
