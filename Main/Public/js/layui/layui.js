...
;!function(e) {
    ...
    n.prototype.define = function(e, t) {
        ...
        return r && (t = e,
        e = []),
        layui["layui.all"] || !layui["layui.all"] && layui["layui.mobile"] ? a.call(n) : (n.use(e, a),
        n)
    }
    ,
    ...
    n.prototype.link = function(e, n, r) {
        ...
        "function" != typeof n ? i : (function p() {
    ...
    n.prototype.extend = function(e) {
        ...
        e = e || {};
        for (var o in e)
            t[o] || t.modules[o] ? a("模块名 " + o + " 已被占用") : t.modules[o] = e[o];
        return t
    }
    ,
    n.prototype.router = function(e) {
        ...
        return /^#\//.test(e) ? (e = e.replace(/^#\//, "").replace(/([^#])(#.*$)/, "$1").split("/") || [],
    ...
    n.prototype.data = function(t, o) {
        ...
        e.JSON && e.JSON.parse) {
            ...
            return o.value && (n[o.key] = o.value),
    ...
    n.prototype.onevent = function(e, t, n) {
        return "string" != typeof e || "function" != typeof n ? this : (o.event[e + "." + t] = [n],
        this)
    }
    ,
    n.prototype.event = function(e, t, n) {
        ...
        return layui.each(o.event[u], l),
        i[0] && layui.each(o.event[t], l),
        a
    }
    ,
    e.layui = new n
