...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "DQqDddG5G1kPrheI"; // AccessKeyId

        $accessKeySecret = "ykxzskBXib2mnhgeLsDtceMVkjmbHk"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($mobile,$System_sign,$code,$TemplateCode) {
        ...
        $request->setSignName($System_sign);
